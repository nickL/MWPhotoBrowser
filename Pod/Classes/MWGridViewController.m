...
// NOTIFY PHOTO BROWSER's delegate (PMBrowserDelegate) that the grid view has
// been scrolled (useful for adding  new cells / infinite scrolling)
//
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    [self.browser gridViewDidScroll:scrollView];
}
